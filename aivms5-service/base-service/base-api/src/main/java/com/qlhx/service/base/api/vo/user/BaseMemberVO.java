...
import com.qlhx.service.base.api.vo.record.BaseNatiomVO;
import com.qlhx.service.base.api.vo.record.UUserDepVO;
...
public class BaseMemberVO extends BaseVO {
    ...
    public BaseNatiomVO getNationNum() {
        return nationNum;
    }

    public void setNationNum(BaseNatiomVO nationNum) {
    ...
    private BaseNatiomVO baseNatiom;

    private UUserDepVO dep;

    private BaseNatiomVO nationNum;
    ...
    public BaseNatiomVO getNations() {
        return nations;
    }

    public void setNations(BaseNatiomVO nations) {
    ...
    public BaseNatiomVO getBaseNatiom() {
        return baseNatiom;
    }

    public void setBaseNatiom(BaseNatiomVO baseNatiom) {
        this.baseNatiom = baseNatiom;
    }

    public UUserDepVO getDep() {
        return dep;
    }

    public void setDep(UUserDepVO dep) {
        this.dep = dep;
    }
