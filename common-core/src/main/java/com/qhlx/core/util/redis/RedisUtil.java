package com.qhlx.core.util.redis;

import com.qhlx.core.util.file.PropertiesUtil;
...
public class RedisUtil {
    ...
    public static void init(String configFilePath) {
        ...
        String passWord = PropertiesUtil.getString(properties, "redisPassWord");
        Integer maxActive = PropertiesUtil.getInt(properties, "max_active");
        Integer maxIdle = PropertiesUtil.getInt(properties, "max_idle");
        Integer maxWait = PropertiesUtil.getInt(properties, "max_wait");
        Integer timeout = PropertiesUtil.getInt(properties, "timeout");
        Boolean testOnBorrow = PropertiesUtil.getBoolean(properties, "test_on_borrow");
        Boolean testOnReturn = PropertiesUtil.getBoolean(properties, "test_on_return");
//        Boolean testWhileIdle = PropertiesUtil.getBoolean(properties, "testWhileIdle");
        ...
        config.setTimeBetweenEvictionRunsMillis(timeout);
        jedisPool = new JedisPool(config, url, port, timeout, passWord);
        logger.info("Initialization redis success ");
    }



    public static RedisUtil getRedisInstance() {
        if (redisUtil == null) {
    ...
    public class Hash {
         ...
         *
         * @param key
         * @param map   Map<String, String> 对应关系
         * @return 状态，成功返回OK
         */
