package com.qhlx.core.util.mail;


import com.qhlx.core.bean.MailBean;
...
public class MailUtil {
    ...
    public static String sendSimpleMail(MailBean mainBean) {
        try {
     ...
     * @return
     */
    private static String checkSendMail(MailBean mainBean){
