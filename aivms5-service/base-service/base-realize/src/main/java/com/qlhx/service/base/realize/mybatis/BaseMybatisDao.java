package com.qlhx.service.base.realize.mybatis;

import com.qlhx.base.util.StringUtil;
import com.qlhx.service.base.realize.mybatis.page.MysqlDialect;
...
public class BaseMybatisDao<T> extends CommonDao {
    ...
    private  Logger logger = LoggerFactory.getLogger(BaseMybatisDao.class);
    /**
     * 默认的查询Sql id
     */
    ...
    public BaseMybatisDao() {
        try {
        	...
        	logger.error("初始化失败，继承BaseMybatisDao，没有泛型！",e);
...
//            if (conn.isClosed()) {
//                conn = ((SqlSessionTemplate) this.getSqlSession()).getSqlSessionFactory().openSession().getConnection();
//            }
...
//            }
            ...
            int totalcount = this.getSqlSession().selectOne(countId, params);
