package com.qlhx.base.util.excel;

import com.qlhx.base.annotation.ExcelField;
import com.qlhx.base.bean.Code;
import com.qlhx.base.bean.DataBean;
...
public class ExcelUtil {
    ...
    private static DataBean<Workbook> createWorkbook(String fileName, InputStream inputStream) {
        ...
        if (fileName == null || "".equals(fileName)) {
            ...
            dataBean.setCode(Code.FAILURE.getCode().toString());
    ...
    private static <T> DataBean<T> baseReadList(String fileName, InputStream inputStream, Class<T> clazz, int startRow, int endRow, int sheetsIndex){
        ...
        if (workbookData.getCode().equals(Code.FAILURE.getCode().toString())) {
        ...
        try {
            ...
            if (sheetData.getCode().equals(Code.FAILURE.getCode().toString())) {
