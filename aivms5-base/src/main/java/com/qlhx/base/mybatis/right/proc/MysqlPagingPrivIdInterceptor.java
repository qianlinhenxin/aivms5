package com.qlhx.base.mybatis.right.proc;


import com.qlhx.base.mybatis.page.AbstractPagingInterceptor;
import com.qlhx.base.page.PageDTO;
import com.qlhx.base.page.PageThreadLocal;
...
public class MysqlPagingPrivIdInterceptor extends AbstractPagingInterceptor {
	...
	protected String getSelectPagingSql(String targetSql, PageDTO<?> pageDto) {
		//String sql = targetSql.toLowerCase(); //日期格式化时转成小写存在问题，注释掉 by 李强，会产生什么后果尚未知
