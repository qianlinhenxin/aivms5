...
import com.qlhx.service.wechat.realize.dao.UPermissionMapper;
import com.qlhx.service.wechat.realize.dao.URolePermissionMapper;
...
import com.qlhx.service.wechat.realize.service.PermissionService;
...
//		executePermission(new Long(1), String.valueOf(record.getId()));
	...
	@Override
	@Transactional
	public int addPermissionRole(Long roleId, String ids) {
	...
	public List<UPermission> selectPermissionListByUserId(Long userId)
	{
		return permissionMapper.selectPermissionListByUserId(userId);
	}
	
	public List<UPermission> selectPermissionListByRoleId(Map param)
	{
		return permissionMapper.selectPermissionListByRoleId(param);
	}

	@Override
	public List<UPermission> selectPermissionAll() {
