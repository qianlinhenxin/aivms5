...
public class DateUtil {
     ...
     * @return
     */
    public static String dateToStringWithTime2() {

        return dateToString(new Date(), DATETIME_PATTERN2);
    }
    ...
    public static int compare_date(String date1, String DATE2) {
        return compare_date(date1, DATE2, DATETIME_PATTERN);
    }
     ...
     * @return
     */
    public static int compare_date(String DATE1, String DATE2, String fmt) {
